...
const FEATURE_SLUG = 'no-collateralcontent-repository-case-studies';
const FEATURE_TITLE = 'No collateral/content repository (case studies, pricing decks)';
const PROJECT = 'AISalesTrainingSimulator';
