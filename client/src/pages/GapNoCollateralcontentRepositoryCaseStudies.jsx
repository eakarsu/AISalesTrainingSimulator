...
export default function GapNoCollateralcontentRepositoryCaseStudies() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-collateralcontent-repository-case-studies', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No collateral/content repository (case studies, pricing decks)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AISalesTrainingSimulator - Gap feature</p>
