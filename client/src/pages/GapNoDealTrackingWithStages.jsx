...
export default function GapNoDealTrackingWithStages() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-deal-tracking-with-stages', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No deal tracking with stages</h1>
