...
export default function GapNoObjectiondatabaseLearnFromPastObjecti() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-objectiondatabase-learn-from-past-objecti', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No /objection-database (learn from past objections)</h1>
